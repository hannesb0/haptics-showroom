...
MyProperties Cube_Aluminium("G1RhombAluminumMesh.JPG", "G1RhombAluminumMeshNormal.JPG", "compressedWood.wav", cVector3d(0.3, 0.3, 0.3), orientation1, MyShape(cube),
	3, 0.6, 0.1, 0.1, 0.1, 1.0, 0.8, 0.8);

MyProperties Sphere_Steel("G3StainlessSteel.JPG", "G3StainlessSteelNormal.JPG", "compressedWood.wav", cVector3d(0.3, 0.3, 0.3), orientation1, MyShape(sphere),
	3, 0.7, 0.1, 0.1, 0.2, 1.0, 0.2, 0.8);

MyProperties Cylinder_Granite("G2GraniteTypeVeneziano.JPG", "G2GraniteTypeVenezianoNormal.JPG", "compressedWood.wav", cVector3d(0.2, 0.2, 0.5), orientation1, MyShape(cylinder),
